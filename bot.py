...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    welcome_text = (
        "היי! 👋 כיף שבאת :) \n\n"
        "בקרוב (אם תאשר לי) אהיה מחובר ללו״ז שלך(Google Calendar) ולמשימות שלך (Google Tasks) ואתחיל לארגן, להכניס ולייעץ לך איך לנהל את הזמן נכון.\n\n"
        ...
        "🧠 <b>הדבר שלשמו התכנסנו - ייעוץ ותכנון מורכב:</b> 'אני חייבת למצוא מחר שעה וחצי כדי לסיים עבודה להגשה וממש רוצה גם להכניס אימון. איך אוכל לעשות את זה בצורה הכי אידיאלית'? \n\n אם צריך - אגיד לך, לדוגמה, אילו אירועים כדאי להזיז ליום אחר, או שאני רואה שצריך לשריין זמן עבודה על דברים נוספים לפי הדד-ליינים שלהם. ועוד טיפים כאלה :)\n\n"
        "סבבה? :) \n כדי להתחיל פשוט תשלח לי הודעה"
    )
