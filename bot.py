...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    "בקרוב (אם תאשר/י לי) אהיה מחובר ללו״ז ולמשימות שלך דרך Google ואתחיל לארגן, להכניס ולייעץ לך איך לנהל את הזמן נכון.\n\n"
    ...
    "⚡ <b>פעולות מהירות:</b> 'תקבע לי פגישה עם הצוות מחר ב-10:00'.\n"
    ...
    "ועוד טיפים כאלה :)\n\n"
    "⚠️ <b>הערה קטנה לפני החיבור:</b>\n\n"
    "בגלל שזה פרויקט פיתוח אישי שלי, במסך הבא תקפוץ לך אזהרה של גוגל ש-Google hasn't verified this app. זה תקין לגמרי! פשוט לחצו על <b>Advanced</b> (מתקדם) ואז על הקישור למטה כדי לאשר.\n\n"
