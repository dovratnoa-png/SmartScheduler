...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    welcome_text = (
        ...
        "🧠 <b>ייעוץ ותכנון מורכב:</b> 'אני חייבת למצוא מחר שעה וחצי לסיים עבודה וממש רוצה גם להכניס אימון. איך אפשר לעשות את זה הכי אידיאלי? ואם צריך - תציע לי אילו פגישות כדאי להזיז ליום ראשון. אגב, אם אתה חושב שאני צריכה להכניס עבודה על מטלות נוספות לפי הדד-ליינים שלהן - תציף'\n\n"
